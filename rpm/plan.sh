...
pkg_source=http://ftp.rpm.org/releases/${pkg_name}-4.12.x/${pkg_name}-${pkg_version}.tar.bz2
pkg_shasum=77ddd228fc332193c874aa0b424f41db1ff8b7edbb6a338703ef747851f50229
pkg_deps=(core/glibc lilian/zlib lilian/nspr lilian/nss lilian/file lilian/popt lilian/libarchive lilian/db)
