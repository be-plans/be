...
pkg_deps=(lilian/gcc-libs core/protobuf/2.5.0)
pkg_build_deps=(lilian/gcc lilian/make lilian/autoconf lilian/automake lilian/libtool lilian/m4 lilian/patch)
pkg_bin_dirs=(bin)
