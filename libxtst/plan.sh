...
pkg_build_deps=(be/gcc be/make core/pkg-config core/xproto core/kbproto core/renderproto core/inputproto core/xextproto core/libpthread-stubs core/libxfixes core/fixesproto core/recordproto)
