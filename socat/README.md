...
This package provides the socat binary.

[socat](http://www.dest-unreach.org/socat/) is a utility for relaying data
between to channels. A myriad channel types are supported, see below.
...
$ echo -e "GET / HTTP/1.1\r\n" | socat - TCP4:google.com:80 | grep OK # HTTP request using socat
HTTP/1.1 200 OK
```
