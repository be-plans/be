...
pkg_deps=(lilian/glibc lilian/python2 lilian/cacerts)
pkg_build_deps=(lilian/gcc lilian/make lilian/python2 lilian/coreutils lilian/diffutils lilian/which)
pkg_lib_dirs=(lib)
pkg_bin_dirs=(bin)
