...
pkg_upstream_url="https://github.com/be-plans/lilian/tree/master/scaffolding-ruby"
pkg_deps=(lilian/bundler lilian/ruby lilian/tar lilian/busybox-static lilian/rq lilian/gcc lilian/make lilian/pkg-config)
