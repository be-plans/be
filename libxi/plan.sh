...
pkg_build_deps=(be/gcc be/make be/pkg-config core/xproto core/xextproto core/kbproto core/inputproto core/libpthread-stubs core/libxfixes core/fixesproto)
