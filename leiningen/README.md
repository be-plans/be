# Habitat package: leiningen

## Description

This plan provides the lein CLI package. `lein` is a tool used to manage Clojure(Script) projects.
...
Build your application with something like:
```
do_build() {
