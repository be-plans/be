...
pkg_deps=(core/glibc lilian/zlib lilian/bzip2 core/readline)
...
if [[ "$STUDIO_TYPE" = "stage1" ]]; then
  pkg_build_deps=(lilian/gcc lilian/coreutils lilian/sed lilian/diffutils core/findutils lilian/make lilian/patch)
fi
