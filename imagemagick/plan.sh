...
pkg_deps=(core/glibc lilian/zlib core/libpng lilian/xz core/gcc-libs)
pkg_build_deps=(lilian/zlib lilian/coreutils lilian/diffutils lilian/patch lilian/make lilian/gcc lilian/sed core/glibc lilian/pkg-config)
pkg_bin_dirs=(bin)
