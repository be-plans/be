...
pkg_deps=(core/busybox core/cacerts lilian/coreutils lilian/openssl  core/erlang)
pkg_build_deps=(core/busybox core/cacerts lilian/coreutils lilian/make lilian/openssl  core/erlang)
pkg_bin_dirs=(bin)
pkg_lib_dirs=(lib)
